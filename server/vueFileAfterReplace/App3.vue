    ...
    <div>
        <el-popover
            ...
            <div style="text-align: right; margin: 0">
                <el-button size="mini" type="text" @click="visible = false">{{$t('ABCDE160')}}</el-button>
                <el-button type="primary" size="mini" @click="visible = false">{{$t('ABCDE161')}}</el-button>
            </div>
            <el-button slot="reference">{{$t('ABCDE162')}}</el-button>
        </el-popover>
        <el-button @click="handleClick">{{!show?$t('collapse'):$t('fold')}}{{$t('job')}}/{{$t('hobbyColumn')}}</el-button>
